...
print("This may take 5-10 minutes depending on rate limits...")
...
# Fetch in batches or sequentially
...
for idx, row in district_info.iterrows():
    ...
    if idx % 50 == 0:
        print(f"  Fetching district {idx+1}/{total}...")
    ...
    while not success and retries < 3:
        try:
            ...
            all_weather_dfs.append(weekly_weather)
            success = True
...
if all_weather_dfs:
    ...
    print("Merging API weather with the dense index...")
    ...
    print("FATAL ERROR: Failed to fetch ANY data from Open-Meteo.")
    print("Falling back to dummy data so the script doesn't crash...")
    new_df['temp_k'] = 300.0
    new_df['preci_mm'] = 0.0
