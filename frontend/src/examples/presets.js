export const PRESETS = {
      ...
      "districts": [
        {
          "censuscode": 572,
          "weeks": [
            { "temp_k": 300.2, "preci_mm": 15.0, "LAI": 0.45, "cases_lag1": 3, "cases_lag2": 2, "cases_lag3": 1, "week_sin": 0.87, "week_cos": 0.5, "is_monsoon": 1, "ner_symptoms": 2, "ner_diseases": 1, "ner_pathogens": 0, "ner_travel": 0, "ner_total_notes": 3 },
            { "temp_k": 301.1, "preci_mm": 35.5, "LAI": 0.48, "cases_lag1": 5, "cases_lag2": 3, "cases_lag3": 2, "week_sin": 0.97, "week_cos": 0.26, "is_monsoon": 1, "ner_symptoms": 4, "ner_diseases": 2, "ner_pathogens": 0, "ner_travel": 0, "ner_total_notes": 6 },
        ...
        },
        {
          "censuscode": 577,
          "weeks": [
            { "temp_k": 298.0, "preci_mm": 8.0, "LAI": 0.42, "cases_lag1": 2, "cases_lag2": 1, "cases_lag3": 1, "week_sin": 0.87, "week_cos": 0.5, "is_monsoon": 1, "ner_symptoms": 1, "ner_diseases": 0, "ner_pathogens": 0, "ner_travel": 0, "ner_total_notes": 2 },
            { "temp_k": 299.2, "preci_mm": 18.4, "LAI": 0.44, "cases_lag1": 3, "cases_lag2": 2, "cases_lag3": 1, "week_sin": 0.97, "week_cos": 0.26, "is_monsoon": 1, "ner_symptoms": 2, "ner_diseases": 1, "ner_pathogens": 0, "ner_travel": 0, "ner_total_notes": 3 },
            { "temp_k": 297.5, "preci_mm": 38.0, "LAI": 0.47, "cases_lag1": 4, "cases_lag2": 3, "cases_lag3": 2, "week_sin": 1.0, "week_cos": 0.0, "is_monsoon": 1, "ner_symptoms": 4, "ner_diseases": 2, "ner_pathogens": 0, "ner_travel": 0, "ner_total_notes": 6 },
            { "temp_k": 296.8, "preci_mm": 52.5, "LAI": 0.50, "cases_lag1": 9, "cases_lag2": 4, "cases_lag3": 3, "week_sin": 0.97, "week_cos": -0.26, "is_monsoon": 1, "ner_symptoms": 8, "ner_diseases": 3, "ner_pathogens": 1, "ner_travel": 1, "ner_total_notes": 11 }
          ]
        }
      ]
    }
  ...
  low_risk: {
    ...
    description: "Dry season with cool temperatures, minimal rain, stable low history of cases, and minimal clinical symptoms.",
    data: {
      "districts": [
        {
          "censuscode": 572,
          "weeks": [
            { "temp_k": 293.5, "preci_mm": 0.5, "LAI": 0.38, "cases_lag1": 1, "cases_lag2": 2, "cases_lag3": 1, "week_sin": -0.5, "week_cos": 0.86, "is_monsoon": 0, "ner_symptoms": 1, "ner_diseases": 0, "ner_pathogens": 0, "ner_travel": 0, "ner_total_notes": 2 },
            { "temp_k": 293.1, "preci_mm": 0.2, "LAI": 0.37, "cases_lag1": 1, "cases_lag2": 1, "cases_lag3": 2, "week_sin": -0.6, "week_cos": 0.8, "is_monsoon": 0, "ner_symptoms": 1, "ner_diseases": 0, "ner_pathogens": 0, "ner_travel": 0, "ner_total_notes": 1 },
            { "temp_k": 292.8, "preci_mm": 1.2, "LAI": 0.36, "cases_lag1": 2, "cases_lag2": 1, "cases_lag3": 1, "week_sin": -0.7, "week_cos": 0.71, "is_monsoon": 0, "ner_symptoms": 2, "ner_diseases": 0, "ner_pathogens": 0, "ner_travel": 0, "ner_total_notes": 3 },
            { "temp_k": 293.0, "preci_mm": 0.2, "LAI": 0.35, "cases_lag1": 1, "cases_lag2": 2, "cases_lag3": 1, "week_sin": -0.8, "week_cos": 0.6, "is_monsoon": 0, "ner_symptoms": 1, "ner_diseases": 0, "ner_pathogens": 0, "ner_travel": 0, "ner_total_notes": 2 }
          ]
        },
        {
          "censuscode": 577,
          "weeks": [
            { "temp_k": 292.5, "preci_mm": 0.0, "LAI": 0.35, "cases_lag1": 1, "cases_lag2": 1, "cases_lag3": 0, "week_sin": -0.5, "week_cos": 0.86, "is_monsoon": 0, "ner_symptoms": 0, "ner_diseases": 0, "ner_pathogens": 0, "ner_travel": 0, "ner_total_notes": 1 },
            { "temp_k": 292.1, "preci_mm": 0.2, "LAI": 0.34, "cases_lag1": 1, "cases_lag2": 1, "cases_lag3": 1, "week_sin": -0.6, "week_cos": 0.8, "is_monsoon": 0, "ner_symptoms": 1, "ner_diseases": 0, "ner_pathogens": 0, "ner_travel": 0, "ner_total_notes": 2 },
            { "temp_k": 291.9, "preci_mm": 0.5, "LAI": 0.33, "cases_lag1": 1, "cases_lag2": 1, "cases_lag3": 1, "week_sin": -0.7, "week_cos": 0.71, "is_monsoon": 0, "ner_symptoms": 1, "ner_diseases": 0, "ner_pathogens": 0, "ner_travel": 0, "ner_total_notes": 1 },
            { "temp_k": 292.0, "preci_mm": 0.1, "LAI": 0.32, "cases_lag1": 1, "cases_lag2": 1, "cases_lag3": 1, "week_sin": -0.8, "week_cos": 0.6, "is_monsoon": 0, "ner_symptoms": 1, "ner_diseases": 0, "ner_pathogens": 0, "ner_travel": 0, "ner_total_notes": 2 }
          ]
        }
      ]
    }
  ...
  spatial_spillover: {
    ...
    description: "Bangalore has an active severe outbreak. Mysore (neighbor) currently has stable low local cases, demonstrating how spatial graph signals propagate risk.",
    data: {
      "districts": [
        {
          "censuscode": 572,
        ...
        },
        {
          "censuscode": 577,
          "weeks": [
            { "temp_k": 298.0, "preci_mm": 5.0, "LAI": 0.40, "cases_lag1": 1, "cases_lag2": 1, "cases_lag3": 0, "week_sin": 0.87, "week_cos": 0.5, "is_monsoon": 1, "ner_symptoms": 1, "ner_total_notes": 2 },
            { "temp_k": 298.5, "preci_mm": 10.2, "LAI": 0.41, "cases_lag1": 1, "cases_lag2": 1, "cases_lag3": 1, "week_sin": 0.97, "week_cos": 0.26, "is_monsoon": 1, "ner_symptoms": 1, "ner_total_notes": 1 },
            { "temp_k": 297.0, "preci_mm": 15.0, "LAI": 0.43, "cases_lag1": 2, "cases_lag2": 1, "cases_lag3": 1, "week_sin": 1.0, "week_cos": 0.0, "is_monsoon": 1, "ner_symptoms": 2, "ner_total_notes": 3 },
            { "temp_k": 296.2, "preci_mm": 20.5, "LAI": 0.45, "cases_lag1": 2, "cases_lag2": 2, "cases_lag3": 1, "week_sin": 0.97, "week_cos": -0.26, "is_monsoon": 1, "ner_symptoms": 2, "ner_total_notes": 4 }
          ]
        }
      ]
    }
      ...
      "districts": [
        {
          "censuscode": 632,
          "weeks": [
            { "temp_k": 298.5, "preci_mm": 5.0, "LAI": 0.44, "cases_lag1": 1, "cases_lag2": 1, "cases_lag3": 1, "week_sin": 0.5, "week_cos": 0.86, "is_monsoon": 0, "ner_symptoms": 2, "ner_total_notes": 3 },
            { "temp_k": 299.0, "preci_mm": 12.0, "LAI": 0.45, "cases_lag1": 1, "cases_lag2": 1, "cases_lag3": 1, "week_sin": 0.6, "week_cos": 0.8, "is_monsoon": 1, "ner_symptoms": 4, "ner_total_notes": 6 },
            { "temp_k": 298.2, "preci_mm": 24.5, "LAI": 0.47, "cases_lag1": 2, "cases_lag2": 1, "cases_lag3": 1, "week_sin": 0.7, "week_cos": 0.71, "is_monsoon": 1, "ner_symptoms": 8, "ner_diseases": 2, "ner_pathogens": 1, "ner_total_notes": 12 },
            { "temp_k": 297.8, "preci_mm": 38.0, "LAI": 0.49, "cases_lag1": 2, "cases_lag2": 2, "cases_lag3": 1, "week_sin": 0.8, "week_cos": 0.6, "is_monsoon": 1, "ner_symptoms": 20, "ner_diseases": 5, "ner_pathogens": 2, "ner_total_notes": 28 }
          ]
        },
        {
          "censuscode": 572,
      ...
      "districts": [
        {
          "censuscode": 94,
          "weeks": [
            { "temp_k": 302.0, "preci_mm": 2.0, "LAI": 0.32, "cases_lag1": 1, "cases_lag2": 1, "cases_lag3": 1, "week_sin": 0.25, "week_cos": 0.96, "is_monsoon": 0, "ner_symptoms": 1, "ner_diseases": 0, "ner_pathogens": 0, "ner_travel": 1, "ner_total_notes": 4 },
            { "temp_k": 303.5, "preci_mm": 8.0, "LAI": 0.31, "cases_lag1": 2, "cases_lag2": 1, "cases_lag3": 1, "week_sin": 0.35, "week_cos": 0.93, "is_monsoon": 0, "ner_symptoms": 2, "ner_diseases": 1, "ner_pathogens": 0, "ner_travel": 3, "ner_total_notes": 8 },
